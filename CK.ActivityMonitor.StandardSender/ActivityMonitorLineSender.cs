...
namespace CK.Core
{
    internal class ActivityMonitorLineSender : ActivityMonitorLogData, IActivityMonitorLineSender
    {
        ...
        /// </summary>
        static internal readonly ActivityMonitorLineSender FakeLineSender = new ActivityMonitorLineSender( null, LogLevel.None, String.Empty, 0 );
        ...
        [MemberNotNullWhen( false, nameof( _monitor ) )]
        public bool IsRejected => _monitor == null;
