...
namespace CK.Core
{
    ...
    public interface IActivityMonitor : IParallelLogger
    {
        ...
        /// When a List&lt;ActivityLogGroupConclusion&gt; is used, it will be directly used to collect conclusion objects (new conclusions will be added to it).
        ...
        /// <summary>
        /// Gets a thread safe <see cref="IParallelLogger"/> for this monitor.
        /// This is not null if and only if the monitor has been initialized with a <see cref="ActivityMonitorOptions.WithParallel"/>.
        /// <para>
        /// Log lines generated by this thread safe logger are emitted through the <see cref="ActivityMonitor.OnStaticLog"/> event,
        /// not through the <see cref="Output"/>: the logs ordering relative to this monitor is preserved BUT these thread safe
