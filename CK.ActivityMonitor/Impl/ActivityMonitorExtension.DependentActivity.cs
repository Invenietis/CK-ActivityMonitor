...
namespace CK.Core
{
    ...
    public static partial class ActivityMonitorExtension
    {
        ...
        /// <para>
        /// The extension method <see cref="StartDependentActivity(IActivityMonitor, ActivityMonitor.DependentToken, string?, int)">StartDependentActivity( token )</see>
        ...
        /// <param name="message">Message for the token creation log.</param>
        ...
        static public ActivityMonitor.DependentToken CreateDependentToken( this IActivityMonitor @this,
                                                                           string message = ActivityMonitor.NoLogText,
