...
namespace CK.Core
{
    public static partial class ActivityMonitorSimpleSenderExtension
    {
        ...
        public static bool Debug( this IActivityLogger logger, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            ...
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber );
        ...
        public static bool Debug( this IActivityLogger logger, string text, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Debug, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber );
                                         ...
                                         [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Debug, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
       ...
       [MethodImpl( MethodImplOptions.AggressiveInlining )]
        ...
        public static bool Trace( this IActivityLogger logger, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            ...
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
        ...
        public static bool Trace( this IActivityLogger logger, string text, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Trace, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
                                         ...
                                         [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Trace, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
       ...
       [MethodImpl( MethodImplOptions.AggressiveInlining )]
        ...
        public static bool Info( this IActivityLogger logger, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            ...
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
        ...
        public static bool Info( this IActivityLogger logger, string text, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Info, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
                                         ...
                                         [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Info, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
       ...
       [MethodImpl( MethodImplOptions.AggressiveInlining )]
        ...
        public static bool Warn( this IActivityLogger logger, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            ...
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
        ...
        public static bool Warn( this IActivityLogger logger, string text, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Warn, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
                                         ...
                                         [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Warn, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
       ...
       [MethodImpl( MethodImplOptions.AggressiveInlining )]
        ...
        public static bool Error( this IActivityLogger logger, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            ...
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
        ...
        public static bool Error( this IActivityLogger logger, string text, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Error, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
                                         ...
                                         [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Error, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
       ...
       [MethodImpl( MethodImplOptions.AggressiveInlining )]
        ...
        public static bool Fatal( this IActivityLogger logger, Exception ex, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            ...
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, finalTags, null, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
        ...
        public static bool Fatal( this IActivityLogger logger, string text, [CallerLineNumber]int lineNumber = 0, [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Fatal, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
                                         ...
                                         [CallerFilePath]string? fileName = null )
        {
            if( logger.ShouldLogLine( LogLevel.Fatal, null, out var finalTags ) )
            {
                var d = logger.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref d );
                return true;
            }
            return false;
                                ...
                                [CallerFilePath] string? fileName = null )
        {
            ...
            if( t != null )
            {
                var line = logger.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber );
                logger.UnfilteredLog( ref line );
                return true;
            }
            return false;
