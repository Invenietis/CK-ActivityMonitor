...
namespace CK.Core
{
    public static partial class ActivityMonitorSimpleSenderExtension
    {
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Debug, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            ...
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Debug, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Debug | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Trace, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Trace, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Trace | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Info, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Info, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Info | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Warn, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Warn, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Warn | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Error, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Error, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Error | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Fatal, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, finalTags, text, null, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, text._handler.FinalTags, t, null, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
        ...
        {
            var d = monitor.ShouldLogGroup( LogLevel.Fatal, null, out var finalTags )
                                                ? monitor.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, finalTags, text, ex, fileName, lineNumber )
                                                : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
                                                  ...
                                                  [CallerFilePath] string? fileName = null )
        {
            var t = text._handler.ToStringAndClear();
            var d = t != null
                    ? monitor.DataFactory.CreateLogData( LogLevel.Fatal | LogLevel.IsFiltered, text._handler.FinalTags, t, ex, fileName, lineNumber )
                    : default;
            return monitor.UnfilteredOpenGroup( ref d );
        }
